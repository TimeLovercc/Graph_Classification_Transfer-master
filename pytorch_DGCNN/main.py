...
class Classifier(nn.Module):
    ...
    def PrepareFeatureLabel_Concat(self, batch_graph):
        if self.regression:
...
if __name__ == '__main__':
    ...
    # train_graphs = train_graphs[:200]
    # for each_train_graph in train_graphs:
    #     print(each_train_graph.label)
    ...
    print('learning rate is {}'.format(cmd_args.learning_rate))
